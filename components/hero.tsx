  ...
  return (
    <section className="bg-accent w-full h-[542px] md:h-[421px] lg:h-[677px] rounded-xl pt-4 px-2 md:pb-[35px] pb-[19px] md:px-[72px] md:pt-[104px] lg:px-[96px] lg:pt-[197px] md:relative">
      ...
      <div className="flex flex-col sm:items-center md:items-start">
        <p className="text-secondary text-center md:text-left w-full text-base md:text-xl lg:text-2xl lg:leading-10 font-biroScript leading-[27px] md:leading-[33px] mt-5">
          diD yOu seE iT ?
        </p>
        <h1 className="text-secondary text-[44px] md:w-full md:flex md:justify-between md:text-[92px] lg:text-[164px] mb-2 md:mb-4 font-black leading-[44px] md:leading-[92px] lg:leading-[164px] tracking-wide">
          <span>YACHT</span>
          <span>APES</span>
        </h1>
        ...
        <div className="flex flex-col-reverse items-center md:flex-col w-full md:items-end md:mt-[-24px]">
          ...
          <button
            type="button"
            className="w-[216px] h-[41px] md:w-[190px] md:h-[41px] md:px-[61px] px-[70px] pt-2.5 pb-3 mb-3 bg-stone-900 bg-opacity-10 rounded-lg backdrop-blur-md justify-center items-center relative top-[-4px] text-secondary text-base font-black leading-[19px] "
          >
            MEET APES
          </button>
        </div>
