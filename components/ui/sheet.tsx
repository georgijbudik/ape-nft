...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background px-4 pt-[130px] pb-6 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
