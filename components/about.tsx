...
const About = () => {
  return (
    <>
      <section
        id="about"
        className="container xs:max-w-[480px] md:max-w-[768px] lg:max-w-[1280px] pt-[60px] md:pt-20 md:relative lg:pt-[120px]"
      >
        <div className="md:flex md:justify-between md:mb-[68px] lg:mb-14">
          <h2 className="xs:w-full w-[216px] md:w-[269px] lg:w-[538px] mb-[6px] text-[40px] md:text-6xl lg:text-[120px] md:mt-[-12px] lg:mt-[-20px] font-black uppercase leading-10 md:leading-[60px] lg:leading-[120px]">
          ...
          <p className="xs:w-full w-[216px] md:w-[275px] lg:w-[409px] mb-9 md:mb-0 text-right text-primary text-base lg:text-2xl font-normal font-messinaSans uppercase leading-[19px] lg:leading-[29px]">
            WHO GOT
            <br className="md:hidden" />
        ...
        <div className="xs:w-full w-[216px] md:w-[269px] lg:w-[417px] flex flex-col items-center mb-10 md:mb-0">
        ...
        <div className="xs:flex w-full xs:justify-center">
          <Image
